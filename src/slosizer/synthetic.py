...
def optimize_trace(trace: RequestTrace) -> RequestTrace:
    ...
    return from_dataframe(
        ...
        schema=RequestSchema(
            ...
            request_model_col="request_model",
            response_model_col="response_model",
            service_tier_col="service_tier",
            ...
            latency_col="observed_latency_s",
            business_value_col="business_value",
        ),
